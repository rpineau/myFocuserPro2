...
PACKAGE_NAME="myFocuserPro2_X2.pkg"
BUNDLE_NAME="org.rti-zone.myFocuserPro2X2"

if [ ! -z "$app_id_signature" ]; then
    codesign -f -s "$app_id_signature" --verbose ../build/Release/libmyFocuserPro2.dylib
fi

mkdir -p ROOT/tmp/myFocuserPro2_X2/
cp "../myFocuserPro2.ui" ROOT/tmp/myFocuserPro2_X2/
cp "../focuserlist myFocuserPro2.txt" ROOT/tmp/myFocuserPro2_X2/
cp "../build/Release/libmyFocuserPro2.dylib" ROOT/tmp/myFocuserPro2_X2/
